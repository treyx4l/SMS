...
$classes = [];
$res     = $conn->prepare("SELECT id, name, section FROM classes WHERE school_id = ? ORDER BY name");
$res->bind_param('i', $schoolId);
$res->execute();
$r = $res->get_result();
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select name="gender">
                    ...
                    $selGender = $edit_student['gender'] ?? '';
                    foreach ($genders as $value => $label): ?>
                        <option value="<?= $value ?>" <?= $selGender === $value ? 'selected' : '' ?>>
                            <?= $label ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="class_id">
                    ...
                    <?php foreach ($classes as $class): ?>
                        <?php
                        $selected = isset($edit_student['class_id']) && (int) $edit_student['class_id'] === (int) $class['id']
                            ? 'selected'
                            : '';
                        ?>
...
<div class="card">
    <div class="card-header">
        ...
        <span class="text-muted">Showing latest records</span>
    </div>
            ...
            <?php else: ?>
                <?php foreach ($students as $index => $student): ?>
                    <tr>
                        ...
                        <td>
                            <a href="admin_students.php?edit_id=<?= (int) $student['id'] ?>"
